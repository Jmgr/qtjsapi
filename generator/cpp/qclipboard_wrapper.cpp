...
QJSValue
QClipboard_WrapperSingleton::tr
(
...
void QClipboard_Wrapper::init(RJSApi& handler) {
    ...
    // singleton wrapper:
    QJSValue mos = engine->newQMetaObject(&QClipboard_WrapperSingleton::staticMetaObject);
    engine->globalObject().setProperty("QClipboard_WrapperSingleton", mos);

    // create instance of singleton wrapper for static functions:
    QClipboard_WrapperSingleton * s = new QClipboard_WrapperSingleton(handler);
    engine->globalObject().setProperty("QClipboard_WrapperSingletonInstance", engine->newQObject(s));
...
QClipboard_Wrapper::QClipboard_Wrapper(RJSApi& h, QClipboard* o, bool wrappedCreated) : RJSWrapperObj(h), wrapped(o), wrappedCreated(wrappedCreated) {
