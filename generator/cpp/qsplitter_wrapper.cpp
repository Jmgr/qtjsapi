...
QJSValue
QSplitter_WrapperSingleton::setTabOrder
(
...
QJSValue
QSplitter_WrapperSingleton::mouseGrabber
(
...
QJSValue
QSplitter_WrapperSingleton::keyboardGrabber
(
...
void QSplitter_Wrapper::init(RJSApi& handler) {

    //qmlRegisterType<QSplitter_Wrapper>("org.qcad", 1, 0, "QSplitter_Wrapper");
    qmlRegisterInterface<QSplitter_Wrapper>("QSplitter_Wrapper", 1);
    ...
    // JS base class:
    //QJSValue mob = engine->newQMetaObject(&QSplitter_BaseJs::staticMetaObject);
    //engine->globalObject().setProperty("QSplitter_BaseJs", mob);

    // singleton wrapper:
    QJSValue mos = engine->newQMetaObject(&QSplitter_WrapperSingleton::staticMetaObject);
    engine->globalObject().setProperty("QSplitter_WrapperSingleton", mos);

    // create instance of singleton wrapper for static functions:
    QSplitter_WrapperSingleton * s = new QSplitter_WrapperSingleton(handler);
    engine->globalObject().setProperty("QSplitter_WrapperSingletonInstance", engine->newQObject(s));
    QJSEngine::setObjectOwnership(s, QJSEngine::CppOwnership);

    QString fileName = ":generator/js/QSplitter.js";
...
QSplitter_Wrapper::QSplitter_Wrapper(QJSEngine* e) : wrapped(nullptr), wrappedCreated(false) {
        //setObjectName("QSplitter_Wrapper");
        setEngine(e);
...
QSplitter_Wrapper::QSplitter_Wrapper(RJSApi& h, QSplitter* o, bool wrappedCreated) : RJSWrapperObj(h), wrapped(o), wrappedCreated(wrappedCreated) {
    //RDebug::incCounter(QString("QSplitter_Wrapper_") + handler.getEngine()->objectName());
    //RDebug::incCounter(QString("QSplitter_Wrapper"));
    //setObjectName("QSplitter_Wrapper");
    //setHandler(h);
...
QSplitter_Wrapper::~QSplitter_Wrapper() {
    //RDebug::decCounter(QString("QSplitter_Wrapper_") + handler.getEngine()->objectName());
    //RDebug::decCounter(QString("QSplitter_Wrapper"));

    //qDebug() << "QSplitter_Wrapper::~QSplitter_Wrapper";
    ...
    if (wrappedCreated) {
        ...
        //qDebug() << "NOT deleting instance of QSplitter";
...
void QSplitter_Wrapper::initConnections() {
    ...
    if (hasWrapped()) {
        ...
        connect(
            ...
            this,
            SLOT(splitterMovedEmitter(int, int))
        );
...

{
    ...
    if (
        ...
        // convert js parameter to cpp:  (Qt::Orientation)
        ...
        //((QSplitter_Base*)wrapped)->setHandler(handler);

        // store self to call into JS:
        ((QSplitter_Base*)wrapped)->self = handler.getSelf();
    ...
    qWarning() << "no matching constructor variant found for QSplitter";
    wrapped = nullptr;
    wrappedCreated = false;
    handler.trace();
...
QJSValue
QSplitter_Wrapper::setObjectName
(
...
QJSValue
QSplitter_Wrapper::isWidgetType
(
...
QJSValue
QSplitter_Wrapper::isWindowType
(
...
QJSValue
QSplitter_Wrapper::signalsBlocked
(
...
QJSValue
QSplitter_Wrapper::blockSignals
(
...
QJSValue
QSplitter_Wrapper::installEventFilter
(
...
QJSValue
QSplitter_Wrapper::removeEventFilter
(
...
QJSValue
QSplitter_Wrapper::dumpObjectTree
(
...
QJSValue
QSplitter_Wrapper::dumpObjectInfo
(
...
QJSValue
QSplitter_Wrapper::dynamicPropertyNames
(
...
QJSValue
QSplitter_Wrapper::windowModality
(
...
QJSValue
QSplitter_Wrapper::setWindowModality
(
...
QJSValue
QSplitter_Wrapper::setWindowModified
(
...
QJSValue
QSplitter_Wrapper::frameGeometry
(
...
QJSValue
QSplitter_Wrapper::normalGeometry
(
...
QJSValue
QSplitter_Wrapper::childrenRect
(
...
QJSValue
QSplitter_Wrapper::childrenRegion
(
...
QJSValue
QSplitter_Wrapper::minimumWidth
(
...
QJSValue
QSplitter_Wrapper::minimumHeight
(
...
QJSValue
QSplitter_Wrapper::maximumWidth
(
...
QJSValue
QSplitter_Wrapper::maximumHeight
(
...
QJSValue
QSplitter_Wrapper::setMinimumSize
(
...
QJSValue
QSplitter_Wrapper::setMaximumSize
(
...
QJSValue
QSplitter_Wrapper::setMinimumWidth
(
...
QJSValue
QSplitter_Wrapper::setMinimumHeight
(
...
QJSValue
QSplitter_Wrapper::setMaximumWidth
(
...
QJSValue
QSplitter_Wrapper::setMaximumHeight
(
...
QJSValue
QSplitter_Wrapper::sizeIncrement
(
...
QJSValue
QSplitter_Wrapper::setSizeIncrement
(
...
QJSValue
QSplitter_Wrapper::setFixedSize
(
...
QJSValue
QSplitter_Wrapper::setFixedWidth
(
...
QJSValue
QSplitter_Wrapper::setFixedHeight
(
...
QJSValue
QSplitter_Wrapper::mapFromGlobal
(
...
QJSValue
QSplitter_Wrapper::mapFromParent
(
...
QJSValue
QSplitter_Wrapper::nativeParentWidget
(
...
QJSValue
QSplitter_Wrapper::topLevelWidget
(
...
QJSValue
QSplitter_Wrapper::setBackgroundRole
(
...
QJSValue
QSplitter_Wrapper::backgroundRole
(
...
QJSValue
QSplitter_Wrapper::setForegroundRole
(
...
QJSValue
QSplitter_Wrapper::foregroundRole
(
...
QJSValue
QSplitter_Wrapper::setMouseTracking
(
...
QJSValue
QSplitter_Wrapper::hasMouseTracking
(
...
QJSValue
QSplitter_Wrapper::setTabletTracking
(
...
QJSValue
QSplitter_Wrapper::hasTabletTracking
(
...
QJSValue
QSplitter_Wrapper::ungrabGesture
(
...
QJSValue
QSplitter_Wrapper::setWindowTitle
(
...
QJSValue
QSplitter_Wrapper::setStyleSheet
(
...
QJSValue
QSplitter_Wrapper::setWindowIcon
(
...
QJSValue
QSplitter_Wrapper::setWindowIconText
(
...
QJSValue
QSplitter_Wrapper::windowIconText
(
...
QJSValue
QSplitter_Wrapper::setWindowRole
(
...
QJSValue
QSplitter_Wrapper::setWindowFilePath
(
...
QJSValue
QSplitter_Wrapper::windowFilePath
(
...
QJSValue
QSplitter_Wrapper::setWindowOpacity
(
...
QJSValue
QSplitter_Wrapper::windowOpacity
(
...
QJSValue
QSplitter_Wrapper::isWindowModified
(
...
QJSValue
QSplitter_Wrapper::setToolTipDuration
(
...
QJSValue
QSplitter_Wrapper::toolTipDuration
(
...
QJSValue
QSplitter_Wrapper::setStatusTip
(
...
QJSValue
QSplitter_Wrapper::setWhatsThis
(
...
QJSValue
QSplitter_Wrapper::accessibleName
(
...
QJSValue
QSplitter_Wrapper::setAccessibleName
(
...
QJSValue
QSplitter_Wrapper::accessibleDescription
(
...
QJSValue
QSplitter_Wrapper::setAccessibleDescription
(
...
QJSValue
QSplitter_Wrapper::setLayoutDirection
(
...
QJSValue
QSplitter_Wrapper::layoutDirection
(
...
QJSValue
QSplitter_Wrapper::unsetLayoutDirection
(
...
QJSValue
QSplitter_Wrapper::isRightToLeft
(
...
QJSValue
QSplitter_Wrapper::isLeftToRight
(
...
QJSValue
QSplitter_Wrapper::isActiveWindow
(
...
QJSValue
QSplitter_Wrapper::activateWindow
(
...
QJSValue
QSplitter_Wrapper::setFocusPolicy
(
...
QJSValue
QSplitter_Wrapper::setFocusProxy
(
...
QJSValue
QSplitter_Wrapper::contextMenuPolicy
(
...
QJSValue
QSplitter_Wrapper::setContextMenuPolicy
(
...
QJSValue
QSplitter_Wrapper::releaseMouse
(
...
QJSValue
QSplitter_Wrapper::grabKeyboard
(
...
QJSValue
QSplitter_Wrapper::releaseKeyboard
(
...
QJSValue
QSplitter_Wrapper::grabShortcut
(
...
QJSValue
QSplitter_Wrapper::releaseShortcut
(
...
QJSValue
QSplitter_Wrapper::setShortcutEnabled
(
...
QJSValue
QSplitter_Wrapper::setShortcutAutoRepeat
(
...
QJSValue
QSplitter_Wrapper::updatesEnabled
(
...
QJSValue
QSplitter_Wrapper::setUpdatesEnabled
(
...
QJSValue
QSplitter_Wrapper::showMinimized
(
...
QJSValue
QSplitter_Wrapper::showMaximized
(
...
QJSValue
QSplitter_Wrapper::showFullScreen
(
...
QJSValue
QSplitter_Wrapper::saveGeometry
(
...
QJSValue
QSplitter_Wrapper::restoreGeometry
(
...
QJSValue
QSplitter_Wrapper::isFullScreen
(
...
QJSValue
QSplitter_Wrapper::setWindowState
(
...
QJSValue
QSplitter_Wrapper::overrideWindowState
(
...
QJSValue
QSplitter_Wrapper::setSizePolicy
(
...
QJSValue
QSplitter_Wrapper::heightForWidth
(
...
QJSValue
QSplitter_Wrapper::hasHeightForWidth
(
...
QJSValue
QSplitter_Wrapper::visibleRegion
(
...
QJSValue
QSplitter_Wrapper::setContentsMargins
(
...
QJSValue
QSplitter_Wrapper::contentsMargins
(
...
QJSValue
QSplitter_Wrapper::contentsRect
(
...
QJSValue
QSplitter_Wrapper::updateGeometry
(
...
QJSValue
QSplitter_Wrapper::nextInFocusChain
(
...
QJSValue
QSplitter_Wrapper::previousInFocusChain
(
...
QJSValue
QSplitter_Wrapper::setAcceptDrops
(
...
QJSValue
QSplitter_Wrapper::insertActions
(
...
QJSValue
QSplitter_Wrapper::insertAction
(
...
QJSValue
QSplitter_Wrapper::removeAction
(
...
QJSValue
QSplitter_Wrapper::parentWidget
(
...
QJSValue
QSplitter_Wrapper::setWindowFlags
(
...
QJSValue
QSplitter_Wrapper::setWindowFlag
(
...
QJSValue
QSplitter_Wrapper::overrideWindowFlags
(
...
QJSValue
QSplitter_Wrapper::setAttribute
(
...
QJSValue
QSplitter_Wrapper::testAttribute
(
...
QJSValue
QSplitter_Wrapper::ensurePolished
(
...
QJSValue
QSplitter_Wrapper::isAncestorOf
(
...
QJSValue
QSplitter_Wrapper::autoFillBackground
(
...
QJSValue
QSplitter_Wrapper::setAutoFillBackground
(
...
void
QSplitter_Wrapper::customContextMenuRequestedEmitter(
    const QPoint& pos
) {
...
QJSValue
QSplitter_Wrapper::inputMethodQuery
(
...
QJSValue
QSplitter_Wrapper::inputMethodHints
(
...
QJSValue
QSplitter_Wrapper::setInputMethodHints
(
...
QJSValue
QSplitter_Wrapper::setFrameStyle
(
...
QJSValue
QSplitter_Wrapper::setFrameShape
(
...
QJSValue
QSplitter_Wrapper::setFrameShadow
(
...
QJSValue
QSplitter_Wrapper::setLineWidth
(
...
QJSValue
QSplitter_Wrapper::midLineWidth
(
...
QJSValue
QSplitter_Wrapper::setMidLineWidth
(
...
QJSValue
QSplitter_Wrapper::setFrameRect
(
...
QJSValue
QSplitter_Wrapper::insertWidget
(
...
QJSValue
QSplitter_Wrapper::replaceWidget
(
...

{
    ...
    qWarning() << "no matching function variant found for replaceWidget";
    handler.trace();
    return QJSValue();
...
QJSValue
QSplitter_Wrapper::setOrientation
(
...
// Class: QSplitter
// Function: setChildrenCollapsible
// Source:
// Static: false
// Parameters: 1
// preceding Parameters: -1
...
QJSValue
QSplitter_Wrapper::setChildrenCollapsible
(
...

{
    ...
    qWarning() << "no matching function variant found for setChildrenCollapsible";
    handler.trace();
    return QJSValue();
...
QJSValue
QSplitter_Wrapper::childrenCollapsible
(
...

{
    ...
    qWarning() << "no matching function variant found for childrenCollapsible";
    handler.trace();
    return QJSValue();
...
QJSValue
QSplitter_Wrapper::setCollapsible
(
...

{
    ...
    qWarning() << "no matching function variant found for setCollapsible";
    handler.trace();
    return QJSValue();
...
QJSValue
QSplitter_Wrapper::isCollapsible
(
...

{
    ...
    qWarning() << "no matching function variant found for isCollapsible";
    handler.trace();
    return QJSValue();
...
QJSValue
QSplitter_Wrapper::setOpaqueResize
(
...

{
    ...
    if (
        ...
        // convert js parameter to cpp: opaque (bool)
    ...
    qWarning() << "no matching function variant found for setOpaqueResize";
    handler.trace();
    return QJSValue();
...
QJSValue
QSplitter_Wrapper::opaqueResize
(
...

{
    ...
    qWarning() << "no matching function variant found for opaqueResize";
    handler.trace();
    return QJSValue();
...
QJSValue
QSplitter_Wrapper::minimumSizeHint
(
...

{
    ...
    qWarning() << "no matching function variant found for sizes";
    handler.trace();
    return QJSValue();
...

{
    ...
    if (
        ...
        // convert js parameter to cpp: list (QList<int>)
    ...
    qWarning() << "no matching function variant found for setSizes";
    handler.trace();
    return QJSValue();
...
QJSValue
QSplitter_Wrapper::restoreState
(
...

{
    ...
    qWarning() << "no matching function variant found for handleWidth";
    handler.trace();
    return QJSValue();
...
QJSValue
QSplitter_Wrapper::setHandleWidth
(
...

{
    ...
    qWarning() << "no matching function variant found for setHandleWidth";
    handler.trace();
    return QJSValue();
...

{
    ...
    if (
        ...
        // return type: QSplitterHandle*

        return RJSHelper::cpp2js_QSplitterHandle(
                   handler,
                   // non-copyable: true
                   res
...
QJSValue
QSplitter_Wrapper::setStretchFactor
(
...

{
    ...
    qWarning() << "no matching function variant found for setStretchFactor";
    handler.trace();
    return QJSValue();
...
// signal emitter: called when signal is emitted from wrapped object:
void
QSplitter_Wrapper::splitterMovedEmitter(
    int pos, int index
) {
    // convert cpp parameters to js:
...

{
    ...
    if (
        ...
        // call function of QSplitter_Base class as
        // function has postfix inheritable class, overridable function):
        QSplitter_Base* wb = getWrappedBase();
        if (wb==nullptr) {
            qWarning() << "QSplitter::resizeEvent: using base but wrapper is not of type of base class";
            handler.trace();
            return QJSValue();
        }
...
QJSValue
QSplitterHandle_WrapperSingleton::setTabOrder
(
...
QJSValue
QSplitterHandle_WrapperSingleton::mouseGrabber
(
...
QJSValue
QSplitterHandle_WrapperSingleton::keyboardGrabber
(
...
void QSplitterHandle_Wrapper::init(RJSApi& handler) {

    //qmlRegisterType<QSplitterHandle_Wrapper>("org.qcad", 1, 0, "QSplitterHandle_Wrapper");
    qmlRegisterInterface<QSplitterHandle_Wrapper>("QSplitterHandle_Wrapper", 1);
    ...
    engine->globalObject().setProperty("QSplitterHandle_Wrapper", mo);



    // JS base class:
    //QJSValue mob = engine->newQMetaObject(&QSplitterHandle_BaseJs::staticMetaObject);
    //engine->globalObject().setProperty("QSplitterHandle_BaseJs", mob);

    // singleton wrapper:
    QJSValue mos = engine->newQMetaObject(&QSplitterHandle_WrapperSingleton::staticMetaObject);
    engine->globalObject().setProperty("QSplitterHandle_WrapperSingleton", mos);

    // create instance of singleton wrapper for static functions:
    QSplitterHandle_WrapperSingleton * s = new QSplitterHandle_WrapperSingleton(handler);
    engine->globalObject().setProperty("QSplitterHandle_WrapperSingletonInstance", engine->newQObject(s));
    QJSEngine::setObjectOwnership(s, QJSEngine::CppOwnership);

    QString fileName = ":generator/js/QSplitterHandle.js";
    QFile scriptFile(fileName);
    if (!scriptFile.open(QIODevice::ReadOnly)) {
        qWarning() << "JS script wrapper file not found:" << fileName;
        return;
...
/*
// special constructor used as prototype:
QSplitterHandle_Wrapper::QSplitterHandle_Wrapper(QJSEngine* e) : wrapped(nullptr), wrappedCreated(false) {
        //setObjectName("QSplitterHandle_Wrapper");
        setEngine(e);
...
// special constructor to wrap existing object:
QSplitterHandle_Wrapper::QSplitterHandle_Wrapper(RJSApi& h, QSplitterHandle* o, bool wrappedCreated) : RJSWrapperObj(h), wrapped(o), wrappedCreated(wrappedCreated) {
    //RDebug::incCounter(QString("QSplitterHandle_Wrapper_") + handler.getEngine()->objectName());
    //RDebug::incCounter(QString("QSplitterHandle_Wrapper"));
    //setObjectName("QSplitterHandle_Wrapper");
    //setHandler(h);
...
// destructor:
QSplitterHandle_Wrapper::~QSplitterHandle_Wrapper() {
    //RDebug::decCounter(QString("QSplitterHandle_Wrapper_") + handler.getEngine()->objectName());
    //RDebug::decCounter(QString("QSplitterHandle_Wrapper"));

    //qDebug() << "QSplitterHandle_Wrapper::~QSplitterHandle_Wrapper";
    ...
    if (wrappedCreated) {
        ...
        // never delete wrapped object (non-copyable, CPP ownership or private destructor)
        //qDebug() << "NOT deleting instance of QSplitterHandle";
...
void QSplitterHandle_Wrapper::initConnections() {
...

{
    ...
    if (
        ...
        && RJSHelper::is_QSplitter_ptr(handler, a2
                                       , true
        ...
        // convert js parameter to cpp: o (Qt::Orientation)

        Qt::Orientation a1_cpp;

        a1_cpp = RJSHelper::js2cpp_Qt_Orientation(handler, a1);

        // convert js parameter to cpp: parent (QSplitter)
        ...
        a2_cpp = RJSHelper::js2cpp_QSplitter_ptr(handler, a2);
        ...
        wrapped = new QSplitterHandle_Base(
            handler
        ...
        // set handler for wrapped base object:
        //((QSplitterHandle_Base*)wrapped)->setHandler(handler);

        // store self to call into JS:
        ((QSplitterHandle_Base*)wrapped)->self = handler.getSelf();
    ...
    qWarning() << "no matching constructor variant found for QSplitterHandle";
    wrapped = nullptr;
    wrappedCreated = false;
    handler.trace();
...
QJSValue
QSplitterHandle_Wrapper::devType
(
...
QJSValue
QSplitterHandle_Wrapper::createWinId
(
...
QJSValue
QSplitterHandle_Wrapper::isWindow
(
...
QJSValue
QSplitterHandle_Wrapper::isModal
(
...
QJSValue
QSplitterHandle_Wrapper::windowModality
(
...
QJSValue
QSplitterHandle_Wrapper::setWindowModality
(
...
QJSValue
QSplitterHandle_Wrapper::isEnabled
(
...
QJSValue
QSplitterHandle_Wrapper::isEnabledTo
(
...
QJSValue
QSplitterHandle_Wrapper::setEnabled
(
...
QJSValue
QSplitterHandle_Wrapper::setDisabled
(
...
QJSValue
QSplitterHandle_Wrapper::setWindowModified
(
...
QJSValue
QSplitterHandle_Wrapper::frameGeometry
(
...
QJSValue
QSplitterHandle_Wrapper::geometry
(
...
QJSValue
QSplitterHandle_Wrapper::normalGeometry
(
...
QJSValue
QSplitterHandle_Wrapper::frameSize
(
...
QJSValue
QSplitterHandle_Wrapper::height
(
...
QJSValue
QSplitterHandle_Wrapper::childrenRect
(
...
QJSValue
QSplitterHandle_Wrapper::childrenRegion
(
...
QJSValue
QSplitterHandle_Wrapper::minimumSize
(
...
QJSValue
QSplitterHandle_Wrapper::maximumSize
(
...
QJSValue
QSplitterHandle_Wrapper::minimumWidth
(
...
QJSValue
QSplitterHandle_Wrapper::minimumHeight
(
...
QJSValue
QSplitterHandle_Wrapper::maximumWidth
(
...
QJSValue
QSplitterHandle_Wrapper::maximumHeight
(
...
QJSValue
QSplitterHandle_Wrapper::setMinimumSize
(
...
QJSValue
QSplitterHandle_Wrapper::setMaximumSize
(
...
QJSValue
QSplitterHandle_Wrapper::setMinimumWidth
(
...
QJSValue
QSplitterHandle_Wrapper::setMinimumHeight
(
...
QJSValue
QSplitterHandle_Wrapper::setMaximumWidth
(
...
QJSValue
QSplitterHandle_Wrapper::setMaximumHeight
(
...
QJSValue
QSplitterHandle_Wrapper::sizeIncrement
(
...
QJSValue
QSplitterHandle_Wrapper::setSizeIncrement
(
...
QJSValue
QSplitterHandle_Wrapper::baseSize
(
...
QJSValue
QSplitterHandle_Wrapper::setBaseSize
(
...
QJSValue
QSplitterHandle_Wrapper::setFixedSize
(
...
QJSValue
QSplitterHandle_Wrapper::setFixedWidth
(
...
QJSValue
QSplitterHandle_Wrapper::setFixedHeight
(
...
QJSValue
QSplitterHandle_Wrapper::mapToGlobal
(
...
QJSValue
QSplitterHandle_Wrapper::mapFromGlobal
(
...
QJSValue
QSplitterHandle_Wrapper::mapToParent
(
...
QJSValue
QSplitterHandle_Wrapper::mapFromParent
(
...
QJSValue
QSplitterHandle_Wrapper::mapFrom
(
...
QJSValue
QSplitterHandle_Wrapper::window
(
...
QJSValue
QSplitterHandle_Wrapper::nativeParentWidget
(
...
QJSValue
QSplitterHandle_Wrapper::topLevelWidget
(
...
QJSValue
QSplitterHandle_Wrapper::palette
(
...
QJSValue
QSplitterHandle_Wrapper::setPalette
(
...
QJSValue
QSplitterHandle_Wrapper::setBackgroundRole
(
...
QJSValue
QSplitterHandle_Wrapper::backgroundRole
(
...
QJSValue
QSplitterHandle_Wrapper::setForegroundRole
(
...
QJSValue
QSplitterHandle_Wrapper::foregroundRole
(
...
QJSValue
QSplitterHandle_Wrapper::setFont
(
...
QJSValue
QSplitterHandle_Wrapper::fontInfo
(
...
QJSValue
QSplitterHandle_Wrapper::cursor
(
...
QJSValue
QSplitterHandle_Wrapper::setCursor
(
...
QJSValue
QSplitterHandle_Wrapper::unsetCursor
(
...
QJSValue
QSplitterHandle_Wrapper::setMouseTracking
(
...
QJSValue
QSplitterHandle_Wrapper::hasMouseTracking
(
...
QJSValue
QSplitterHandle_Wrapper::underMouse
(
...
QJSValue
QSplitterHandle_Wrapper::setTabletTracking
(
...
QJSValue
QSplitterHandle_Wrapper::hasTabletTracking
(
...
QJSValue
QSplitterHandle_Wrapper::setMask
(
...
QJSValue
QSplitterHandle_Wrapper::clearMask
(
...
QJSValue
QSplitterHandle_Wrapper::grabGesture
(
...
QJSValue
QSplitterHandle_Wrapper::ungrabGesture
(
...
QJSValue
QSplitterHandle_Wrapper::setWindowTitle
(
...
QJSValue
QSplitterHandle_Wrapper::setStyleSheet
(
...
QJSValue
QSplitterHandle_Wrapper::styleSheet
(
...
QJSValue
QSplitterHandle_Wrapper::windowTitle
(
...
QJSValue
QSplitterHandle_Wrapper::setWindowIcon
(
...
QJSValue
QSplitterHandle_Wrapper::windowIcon
(
...
QJSValue
QSplitterHandle_Wrapper::setWindowIconText
(
...
QJSValue
QSplitterHandle_Wrapper::windowIconText
(
...
QJSValue
QSplitterHandle_Wrapper::setWindowRole
(
...
QJSValue
QSplitterHandle_Wrapper::windowRole
(
...
QJSValue
QSplitterHandle_Wrapper::setWindowFilePath
(
...
QJSValue
QSplitterHandle_Wrapper::windowFilePath
(
...
QJSValue
QSplitterHandle_Wrapper::setWindowOpacity
(
...
QJSValue
QSplitterHandle_Wrapper::windowOpacity
(
...
QJSValue
QSplitterHandle_Wrapper::isWindowModified
(
...
QJSValue
QSplitterHandle_Wrapper::setToolTip
(
...
QJSValue
QSplitterHandle_Wrapper::toolTip
(
...
QJSValue
QSplitterHandle_Wrapper::setToolTipDuration
(
...
QJSValue
QSplitterHandle_Wrapper::toolTipDuration
(
...
QJSValue
QSplitterHandle_Wrapper::setStatusTip
(
...
QJSValue
QSplitterHandle_Wrapper::statusTip
(
...
QJSValue
QSplitterHandle_Wrapper::setWhatsThis
(
...
QJSValue
QSplitterHandle_Wrapper::whatsThis
(
...
QJSValue
QSplitterHandle_Wrapper::accessibleName
(
...
QJSValue
QSplitterHandle_Wrapper::setAccessibleName
(
...
QJSValue
QSplitterHandle_Wrapper::accessibleDescription
(
...
QJSValue
QSplitterHandle_Wrapper::setAccessibleDescription
(
...
QJSValue
QSplitterHandle_Wrapper::setLayoutDirection
(
...
QJSValue
QSplitterHandle_Wrapper::layoutDirection
(
...
QJSValue
QSplitterHandle_Wrapper::unsetLayoutDirection
(
...
QJSValue
QSplitterHandle_Wrapper::setLocale
(
...
QJSValue
QSplitterHandle_Wrapper::locale
(
...
QJSValue
QSplitterHandle_Wrapper::unsetLocale
(
...
QJSValue
QSplitterHandle_Wrapper::isRightToLeft
(
...
QJSValue
QSplitterHandle_Wrapper::isLeftToRight
(
...
QJSValue
QSplitterHandle_Wrapper::isActiveWindow
(
...
QJSValue
QSplitterHandle_Wrapper::activateWindow
(
...
QJSValue
QSplitterHandle_Wrapper::clearFocus
(
...
QJSValue
QSplitterHandle_Wrapper::setFocus
(
...
QJSValue
QSplitterHandle_Wrapper::focusPolicy
(
...
QJSValue
QSplitterHandle_Wrapper::setFocusPolicy
(
...
QJSValue
QSplitterHandle_Wrapper::hasFocus
(
...
QJSValue
QSplitterHandle_Wrapper::setFocusProxy
(
...
QJSValue
QSplitterHandle_Wrapper::focusProxy
(
...
QJSValue
QSplitterHandle_Wrapper::contextMenuPolicy
(
...
QJSValue
QSplitterHandle_Wrapper::setContextMenuPolicy
(
...
QJSValue
QSplitterHandle_Wrapper::grabMouse
(
...
QJSValue
QSplitterHandle_Wrapper::releaseMouse
(
...
QJSValue
QSplitterHandle_Wrapper::grabKeyboard
(
...
QJSValue
QSplitterHandle_Wrapper::releaseKeyboard
(
...
QJSValue
QSplitterHandle_Wrapper::grabShortcut
(
...
QJSValue
QSplitterHandle_Wrapper::releaseShortcut
(
...
QJSValue
QSplitterHandle_Wrapper::setShortcutEnabled
(
...
QJSValue
QSplitterHandle_Wrapper::setShortcutAutoRepeat
(
...
QJSValue
QSplitterHandle_Wrapper::updatesEnabled
(
...
QJSValue
QSplitterHandle_Wrapper::setUpdatesEnabled
(
...
QJSValue
QSplitterHandle_Wrapper::update
(
...
QJSValue
QSplitterHandle_Wrapper::repaint
(
...
QJSValue
QSplitterHandle_Wrapper::setVisible
(
...
QJSValue
QSplitterHandle_Wrapper::setHidden
(
...
QJSValue
QSplitterHandle_Wrapper::showMinimized
(
...
QJSValue
QSplitterHandle_Wrapper::showMaximized
(
...
QJSValue
QSplitterHandle_Wrapper::showFullScreen
(
...
QJSValue
QSplitterHandle_Wrapper::showNormal
(
...
QJSValue
QSplitterHandle_Wrapper::stackUnder
(
...
QJSValue
QSplitterHandle_Wrapper::resize
(
...
QJSValue
QSplitterHandle_Wrapper::setGeometry
(
...
QJSValue
QSplitterHandle_Wrapper::saveGeometry
(
...
QJSValue
QSplitterHandle_Wrapper::restoreGeometry
(
...
QJSValue
QSplitterHandle_Wrapper::adjustSize
(
...
QJSValue
QSplitterHandle_Wrapper::isVisible
(
...
QJSValue
QSplitterHandle_Wrapper::isVisibleTo
(
...
QJSValue
QSplitterHandle_Wrapper::isHidden
(
...
QJSValue
QSplitterHandle_Wrapper::isMinimized
(
...
QJSValue
QSplitterHandle_Wrapper::isMaximized
(
...
QJSValue
QSplitterHandle_Wrapper::isFullScreen
(
...
QJSValue
QSplitterHandle_Wrapper::windowState
(
...
QJSValue
QSplitterHandle_Wrapper::setWindowState
(
...
QJSValue
QSplitterHandle_Wrapper::overrideWindowState
(
...
QJSValue
QSplitterHandle_Wrapper::minimumSizeHint
(
...
QJSValue
QSplitterHandle_Wrapper::sizePolicy
(
...
QJSValue
QSplitterHandle_Wrapper::setSizePolicy
(
...
QJSValue
QSplitterHandle_Wrapper::heightForWidth
(
...
QJSValue
QSplitterHandle_Wrapper::hasHeightForWidth
(
...
QJSValue
QSplitterHandle_Wrapper::visibleRegion
(
...
QJSValue
QSplitterHandle_Wrapper::setContentsMargins
(
...
QJSValue
QSplitterHandle_Wrapper::contentsMargins
(
...
QJSValue
QSplitterHandle_Wrapper::contentsRect
(
...
QJSValue
QSplitterHandle_Wrapper::layout
(
...
QJSValue
QSplitterHandle_Wrapper::setLayout
(
...
QJSValue
QSplitterHandle_Wrapper::updateGeometry
(
...
QJSValue
QSplitterHandle_Wrapper::setParent
(
...
QJSValue
QSplitterHandle_Wrapper::scroll
(
...
QJSValue
QSplitterHandle_Wrapper::focusWidget
(
...
QJSValue
QSplitterHandle_Wrapper::nextInFocusChain
(
...
QJSValue
QSplitterHandle_Wrapper::previousInFocusChain
(
...
QJSValue
QSplitterHandle_Wrapper::acceptDrops
(
...
QJSValue
QSplitterHandle_Wrapper::setAcceptDrops
(
...
QJSValue
QSplitterHandle_Wrapper::addAction
(
...
QJSValue
QSplitterHandle_Wrapper::addActions
(
...
QJSValue
QSplitterHandle_Wrapper::insertActions
(
...
QJSValue
QSplitterHandle_Wrapper::insertAction
(
...
QJSValue
QSplitterHandle_Wrapper::removeAction
(
...
QJSValue
QSplitterHandle_Wrapper::actions
(
...
QJSValue
QSplitterHandle_Wrapper::parentWidget
(
...
QJSValue
QSplitterHandle_Wrapper::setWindowFlags
(
...
QJSValue
QSplitterHandle_Wrapper::windowFlags
(
...
QJSValue
QSplitterHandle_Wrapper::setWindowFlag
(
...
QJSValue
QSplitterHandle_Wrapper::overrideWindowFlags
(
...
QJSValue
QSplitterHandle_Wrapper::windowType
(
...
QJSValue
QSplitterHandle_Wrapper::childAt
(
...
QJSValue
QSplitterHandle_Wrapper::setAttribute
(
...
QJSValue
QSplitterHandle_Wrapper::testAttribute
(
...
QJSValue
QSplitterHandle_Wrapper::ensurePolished
(
...
QJSValue
QSplitterHandle_Wrapper::isAncestorOf
(
...
QJSValue
QSplitterHandle_Wrapper::autoFillBackground
(
...
QJSValue
QSplitterHandle_Wrapper::setAutoFillBackground
(
...
// signal emitter: called when signal is emitted from wrapped object:
void
QSplitterHandle_Wrapper::customContextMenuRequestedEmitter(
    const QPoint& pos
) {
    // convert cpp parameters to js:
...
QJSValue
QSplitterHandle_Wrapper::inputMethodQuery
(
...
QJSValue
QSplitterHandle_Wrapper::inputMethodHints
(
...
QJSValue
QSplitterHandle_Wrapper::setInputMethodHints
(
...
QJSValue
QSplitterHandle_Wrapper::setOrientation
(
...
QJSValue
QSplitterHandle_Wrapper::orientation
(
...
QJSValue
QSplitterHandle_Wrapper::opaqueResize
(
...
QJSValue
QSplitterHandle_Wrapper::splitter
(
...

{

    {
        ...
        return RJSHelper::cpp2js_QSplitter(
                   handler,
                   // non-copyable: true
                   res
    ...
    qWarning() << "no matching function variant found for splitter";
    handler.trace();
    return QJSValue();
...
QJSValue
QSplitterHandle_Wrapper::sizeHint
(
...

{
    ...
    if (
        ...
        // call function of QSplitterHandle_Base class as
        // function has postfix inheritable class, overridable function):
        QSplitterHandle_Base* wb = getWrappedBase();
        if (wb==nullptr) {
            qWarning() << "QSplitterHandle::paintEvent: using base but wrapper is not of type of base class";
            handler.trace();
            return QJSValue();
        }
...

{
    ...
    if (
        ...
        QSplitterHandle_Base* wb = getWrappedBase();
        if (wb==nullptr) {
            qWarning() << "QSplitterHandle::mouseMoveEvent: using base but wrapper is not of type of base class";
            handler.trace();
            return QJSValue();
        }
...

{
    ...
    if (
        ...
        QSplitterHandle_Base* wb = getWrappedBase();
        if (wb==nullptr) {
            qWarning() << "QSplitterHandle::resizeEvent: using base but wrapper is not of type of base class";
            handler.trace();
            return QJSValue();
        }
