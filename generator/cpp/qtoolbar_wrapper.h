...
public:
    //Q_INVOKABLE
    QToolBar_WrapperSingleton(RJSApi& h)
        : QObject(),
          handler(h)
...
private:
    RJSApi& handler;
    //static QToolBar_WrapperSingleton* _singleInstance;
...
// wrapper class for QToolBar
class QTJSAPI_EXPORT QToolBar_Wrapper : public RJSWrapperObj {
    ...
    Q_PROPERTY(
        ...
        QJSValue
        floatable READ isFloatable WRITE setFloatable
    )
...
private:
    ...
    QToolBar_Wrapper(const QToolBar_Wrapper&);

public:
    // initialization of QToolBar:
    static void init(RJSApi& handler);


    static QToolBar* castToBase(void* vp, /*RJSType ID*/ int t) {
        ...
        qWarning() << "QToolBar_Wrapper::castToBase: type not found: " << RJSHelper::getTypeName(t);

        return nullptr;

    }

    static QToolBar* getWrappedBase(RJSWrapper* wrapper) {
        int t = wrapper->getWrappedType();
        void* vp = wrapper->getWrappedVoid();
        if (vp==nullptr) {
            //qWarning() << "getWrapped_QToolBar*: wrapper wraps NULL";
        }

        QToolBar* ret = castToBase(vp, t);
        if (ret==nullptr && vp!=nullptr) {
            qWarning() << "QToolBar*_Wrapper::getWrappedBase: extracted type " << t << "from wrapper is NULL";
        }
        return ret;
    }
    ...
    */
    ...
    //Q_INVOKABLE
    QToolBar_Wrapper(RJSApi& h, QToolBar* o, bool wrappedCreated);


    // destructor:

    virtual ~QToolBar_Wrapper();
...
public:
    ...
    QToolBar_Base* getWrappedBase() {
        QToolBar* w = getWrapped();
        return dynamic_cast<QToolBar_Base*>(w);
    }

    QToolBar_Base* getWrappedBase() const {
        QToolBar* w = getWrapped();
        return dynamic_cast<QToolBar_Base*>(w);
    }
...
private:
    ...
    static QList<RJSBasecaster_QToolBar*> basecasters_QToolBar;

public:
    static void registerBasecaster_QToolBar(RJSBasecaster_QToolBar* bc) {
        basecasters_QToolBar.append(bc);
    }

};

Q_DECLARE_METATYPE(QToolBar_Wrapper*)

Q_DECLARE_INTERFACE(QToolBar_Wrapper, "org.qcad.QToolBar_Wrapper")
