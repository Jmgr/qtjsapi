...
void QIODevice_Wrapper::init(RJSApi& handler) {
    ...
    // singleton wrapper:
    QJSValue mos = engine->newQMetaObject(&QIODevice_WrapperSingleton::staticMetaObject);
    engine->globalObject().setProperty("QIODevice_WrapperSingleton", mos);

    // create instance of singleton wrapper for static functions:
    QIODevice_WrapperSingleton * s = new QIODevice_WrapperSingleton(handler);
    engine->globalObject().setProperty("QIODevice_WrapperSingletonInstance", engine->newQObject(s));
...
QIODevice_Wrapper::QIODevice_Wrapper(RJSApi& h, QIODevice* o, bool wrappedCreated) : RJSWrapperObj(h), wrapped(o), wrappedCreated(wrappedCreated) {
