...
#ifndef QMENUBAR_H_WRAPPER
#define QMENUBAR_H_WRAPPER
...
// wrapped object is QMenuBar_Base class if new object is created:
...
public:
    //Q_INVOKABLE
    QMenuBar_WrapperSingleton(RJSApi& h)
        : QObject(),
          handler(h)
...
private:
    RJSApi& handler;
    //static QMenuBar_WrapperSingleton* _singleInstance;
...
private:
    ...
    QMenuBar_Wrapper(const QMenuBar_Wrapper&);

public:
    // initialization of QMenuBar:
    ...
    static QMenuBar* castToBase(void* vp, /*RJSType ID*/ int t) {
        ...
        qWarning() << "QMenuBar_Wrapper::castToBase: type not found: " << RJSHelper::getTypeName(t);
    ...
    static QMenuBar* getWrappedBase(RJSWrapper* wrapper) {
        ...
        QMenuBar* ret = castToBase(vp, t);
        if (ret==nullptr && vp!=nullptr) {
            qWarning() << "QMenuBar*_Wrapper::getWrappedBase: extracted type " << t << "from wrapper is NULL";
        }
        return ret;
    }
    ...
    */
    ...
    //Q_INVOKABLE
    QMenuBar_Wrapper(RJSApi& h, QMenuBar* o, bool wrappedCreated);


    // destructor:

    virtual ~QMenuBar_Wrapper();
...
public:
    ...
    QMenuBar_Base* getWrappedBase() {
        QMenuBar* w = getWrapped();
        return dynamic_cast<QMenuBar_Base*>(w);
    }

    QMenuBar_Base* getWrappedBase() const {
        QMenuBar* w = getWrapped();
        return dynamic_cast<QMenuBar_Base*>(w);
    }
...
private:
    ...
    static QList<RJSBasecaster_QMenuBar*> basecasters_QMenuBar;

public:
    static void registerBasecaster_QMenuBar(RJSBasecaster_QMenuBar* bc) {
        basecasters_QMenuBar.append(bc);
    }

};

Q_DECLARE_METATYPE(QMenuBar_Wrapper*)

Q_DECLARE_INTERFACE(QMenuBar_Wrapper, "org.qcad.QMenuBar_Wrapper")
