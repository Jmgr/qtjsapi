...
public:
    //Q_INVOKABLE
    QStatusBar_WrapperSingleton(RJSApi& h)
        : QObject(),
          handler(h)
...
private:
    RJSApi& handler;
    //static QStatusBar_WrapperSingleton* _singleInstance;
...
// wrapper class for QStatusBar
class QTJSAPI_EXPORT QStatusBar_Wrapper : public RJSWrapperObj {
...
private:
    ...
    QStatusBar_Wrapper(const QStatusBar_Wrapper&);

public:
    // initialization of QStatusBar:
    ...
    static QStatusBar* getWrappedBase(RJSWrapper* wrapper) {
        ...
        QStatusBar* ret = castToBase(vp, t);
        if (ret==nullptr && vp!=nullptr) {
            qWarning() << "QStatusBar*_Wrapper::getWrappedBase: extracted type " << t << "from wrapper is NULL";
        }
        return ret;
    }
    ...
    // special constructor used as prototype:
          ...
          Q_INVOKABLE
          QStatusBar_Wrapper(QJSEngine* e);
    ...
    */
    ...
    //Q_INVOKABLE
    QStatusBar_Wrapper(RJSApi& h, QStatusBar* o, bool wrappedCreated);


    // destructor:

    virtual ~QStatusBar_Wrapper();
...
public:
    ...
    QStatusBar_Base* getWrappedBase() {
        QStatusBar* w = getWrapped();
        return dynamic_cast<QStatusBar_Base*>(w);
    }

    QStatusBar_Base* getWrappedBase() const {
        QStatusBar* w = getWrapped();
        return dynamic_cast<QStatusBar_Base*>(w);
    }
...
private:
    ...
    static QList<RJSBasecaster_QStatusBar*> basecasters_QStatusBar;

public:
    static void registerBasecaster_QStatusBar(RJSBasecaster_QStatusBar* bc) {
        basecasters_QStatusBar.append(bc);
    }

};

Q_DECLARE_METATYPE(QStatusBar_Wrapper*)

Q_DECLARE_INTERFACE(QStatusBar_Wrapper, "org.qcad.QStatusBar_Wrapper")
