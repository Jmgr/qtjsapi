...
void QProgressBar_Base::mousePressEvent(
    QMouseEvent* event
) {

    //qDebug() << "QProgressBar_Base::mousePressEvent()";
...
void QProgressBar_Base::mouseReleaseEvent(
    QMouseEvent* event
) {

    //qDebug() << "QProgressBar_Base::mouseReleaseEvent()";
...
void QProgressBar_Base::mouseMoveEvent(
    QMouseEvent* event
) {

    //qDebug() << "QProgressBar_Base::mouseMoveEvent()";
...
void QProgressBar_Base::resizeEvent(
    QResizeEvent* event
) {

    //qDebug() << "QProgressBar_Base::resizeEvent()";
...
void QProgressBar_Base::actionEvent(
    QActionEvent* event
) {

    //qDebug() << "QProgressBar_Base::actionEvent()";
...
bool QProgressBar_Base::event(
    QEvent* e
) {

    //qDebug() << "QProgressBar_Base::event()";
...
void QProgressBar_Base::paintEvent(
    QPaintEvent* a1
) {

    //qDebug() << "QProgressBar_Base::paintEvent()";
