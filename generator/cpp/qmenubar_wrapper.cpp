...
QList<RJSBasecaster_QMenuBar*> QMenuBar_Wrapper::basecasters_QMenuBar;
...
void QMenuBar_Wrapper::init(RJSApi& handler) {
    ...
    RJSType_QMenuBar* t = new RJSType_QMenuBar();
    global.setProperty("RJSType_QMenuBar", engine->newQObject(t));
    ...
    QString fileName = ":generator/js/QMenuBar.js";
