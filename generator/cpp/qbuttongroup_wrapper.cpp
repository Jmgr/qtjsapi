...
QList<RJSBasecaster_QButtonGroup*> QButtonGroup_Wrapper::basecasters_QButtonGroup;
...
void QButtonGroup_Wrapper::init(RJSApi& handler) {
    ...
    RJSType_QButtonGroup* t = new RJSType_QButtonGroup();
    global.setProperty("RJSType_QButtonGroup", engine->newQObject(t));
