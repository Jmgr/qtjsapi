...
void QWindow_Base::resizeEvent(
    QResizeEvent* a1
) {

    //qDebug() << "QWindow_Base::resizeEvent()";
...
void QWindow_Base::paintEvent(
    QPaintEvent* a1
) {

    //qDebug() << "QWindow_Base::paintEvent()";
...
void QWindow_Base::mouseMoveEvent(
    QMouseEvent* a1
) {

    //qDebug() << "QWindow_Base::mouseMoveEvent()";
