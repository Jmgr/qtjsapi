...
public:
    //Q_INVOKABLE
    QSpinBox_WrapperSingleton(RJSApi& h)
        : QObject(),
          handler(h)
...
private:
    RJSApi& handler;
    //static QSpinBox_WrapperSingleton* _singleInstance;
...
class QTJSAPI_EXPORT QSpinBox_Wrapper : public RJSWrapperObj {
    ...
    Q_PROPERTY(
        ...
        QJSValue
        prefix READ prefix WRITE setPrefix
    )

    Q_PROPERTY(

        QJSValue
        cleanText READ cleanText
    )
    ...
    Q_PROPERTY(
        ...
        QJSValue
        stepType READ stepType WRITE setStepType
    )
    ...
    Q_PROPERTY(
        ...
        QJSValue
        displayIntegerBase READ displayIntegerBase WRITE setDisplayIntegerBase
    )


private:
    // disable copy constructor:
    QSpinBox_Wrapper(const QSpinBox_Wrapper&);

public:
    // initialization of QSpinBox:
    ...
    static QSpinBox* getWrappedBase(RJSWrapper* wrapper) {
        int t = wrapper->getWrappedType();
        void* vp = wrapper->getWrappedVoid();
        if (vp==nullptr) {
            //qWarning() << "getWrapped_QSpinBox*: wrapper wraps NULL";
        }

        QSpinBox* ret = castToBase(vp, t);
        if (ret==nullptr && vp!=nullptr) {
            qWarning() << "QSpinBox*_Wrapper::getWrappedBase: extracted type " << t << "from wrapper is NULL";
        }
        return ret;
    }
    ...
    */
    ...
    //Q_INVOKABLE
    QSpinBox_Wrapper(RJSApi& h, QSpinBox* o, bool wrappedCreated);


    // destructor:

    virtual ~QSpinBox_Wrapper();
...
public:
    ...
    QSpinBox_Base* getWrappedBase() {
        QSpinBox* w = getWrapped();
        return dynamic_cast<QSpinBox_Base*>(w);
    }

    QSpinBox_Base* getWrappedBase() const {
        QSpinBox* w = getWrapped();
        return dynamic_cast<QSpinBox_Base*>(w);
    }
...
Q_DECLARE_INTERFACE(QSpinBox_Wrapper, "org.qcad.QSpinBox_Wrapper")
...
private:
    // disable copy constructor:
    QDoubleSpinBox_Wrapper(const QDoubleSpinBox_Wrapper&);

public:
    // initialization of QDoubleSpinBox:
    static void init(RJSApi& handler);
    ...
    static QDoubleSpinBox* getWrappedBase(RJSWrapper* wrapper) {
        int t = wrapper->getWrappedType();
        void* vp = wrapper->getWrappedVoid();
        if (vp==nullptr) {
            //qWarning() << "getWrapped_QDoubleSpinBox*: wrapper wraps NULL";
        }

        QDoubleSpinBox* ret = castToBase(vp, t);
        if (ret==nullptr && vp!=nullptr) {
            qWarning() << "QDoubleSpinBox*_Wrapper::getWrappedBase: extracted type " << t << "from wrapper is NULL";
        }
        return ret;
    }
    ...
    // special constructor used as prototype:
          ...
          Q_INVOKABLE
          QDoubleSpinBox_Wrapper(QJSEngine* e);
    ...
    */
    ...
    //Q_INVOKABLE
    QDoubleSpinBox_Wrapper(RJSApi& h, QDoubleSpinBox* o, bool wrappedCreated);


    // destructor:

    virtual ~QDoubleSpinBox_Wrapper();
...
public:
    ...
    // get wrapped object (const):
    QDoubleSpinBox* getWrapped() const {
        if (wrapped!=nullptr) {
            return wrapped;
        }
...
Q_DECLARE_METATYPE(QDoubleSpinBox_Wrapper*)

Q_DECLARE_INTERFACE(QDoubleSpinBox_Wrapper, "org.qcad.QDoubleSpinBox_Wrapper")
