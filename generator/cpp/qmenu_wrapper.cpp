...
QJSValue
QMenu_WrapperSingleton::setTabOrder
(
...
QJSValue
QMenu_WrapperSingleton::mouseGrabber
(
...
QJSValue
QMenu_WrapperSingleton::keyboardGrabber
(
...

{
    ...
    if (
        ...
        && RJSHelper::is_QWidget_ptr(handler, a4
                                     , true
        ...
        // convert js parameter to cpp: at (QAction)
        ...
        if (a4.isUndefined()) {
            ...
            a4_cpp = RJSHelper::js2cpp_QWidget_ptr(handler, a4);
        }
...
void QMenu_Wrapper::init(RJSApi& handler) {

    //qmlRegisterType<QMenu_Wrapper>("org.qcad", 1, 0, "QMenu_Wrapper");
    qmlRegisterInterface<QMenu_Wrapper>("QMenu_Wrapper", 1);
    ...
    // JS base class:
    //QJSValue mob = engine->newQMetaObject(&QMenu_BaseJs::staticMetaObject);
    //engine->globalObject().setProperty("QMenu_BaseJs", mob);

    // singleton wrapper:
    QJSValue mos = engine->newQMetaObject(&QMenu_WrapperSingleton::staticMetaObject);
    engine->globalObject().setProperty("QMenu_WrapperSingleton", mos);

    // create instance of singleton wrapper for static functions:
    QMenu_WrapperSingleton * s = new QMenu_WrapperSingleton(handler);
...
QMenu_Wrapper::QMenu_Wrapper(QJSEngine* e) : wrapped(nullptr), wrappedCreated(false) {
        //setObjectName("QMenu_Wrapper");
        setEngine(e);
...
QMenu_Wrapper::QMenu_Wrapper(RJSApi& h, QMenu* o, bool wrappedCreated) : RJSWrapperObj(h), wrapped(o), wrappedCreated(wrappedCreated) {
    //RDebug::incCounter(QString("QMenu_Wrapper_") + handler.getEngine()->objectName());
    //RDebug::incCounter(QString("QMenu_Wrapper"));
    //setObjectName("QMenu_Wrapper");
    //setHandler(h);
...
QMenu_Wrapper::~QMenu_Wrapper() {
    //RDebug::decCounter(QString("QMenu_Wrapper_") + handler.getEngine()->objectName());
    //RDebug::decCounter(QString("QMenu_Wrapper"));

    //qDebug() << "QMenu_Wrapper::~QMenu_Wrapper";
    ...
    if (wrappedCreated) {
        ...
        //qDebug() << "NOT deleting instance of QMenu";
...
void QMenu_Wrapper::initConnections() {
...

{
    ...
    if (
        ...
        //((QMenu_Base*)wrapped)->setHandler(handler);

        // store self to call into JS:
        ((QMenu_Base*)wrapped)->self = handler.getSelf();
    ...
    qWarning() << "no matching constructor variant found for QMenu";
    wrapped = nullptr;
    wrappedCreated = false;
    handler.trace();
...
QJSValue
QMenu_Wrapper::installEventFilter
(
...
QJSValue
QMenu_Wrapper::removeEventFilter
(
...
QJSValue
QMenu_Wrapper::dynamicPropertyNames
(
...
QJSValue
QMenu_Wrapper::setWindowModality
(
...
QJSValue
QMenu_Wrapper::setWindowModified
(
...
QJSValue
QMenu_Wrapper::setMinimumHeight
(
...
QJSValue
QMenu_Wrapper::setMaximumHeight
(
...
QJSValue
QMenu_Wrapper::setSizeIncrement
(
...
QJSValue
QMenu_Wrapper::nativeParentWidget
(
...
QJSValue
QMenu_Wrapper::setBackgroundRole
(
...
QJSValue
QMenu_Wrapper::setForegroundRole
(
...
QJSValue
QMenu_Wrapper::setMouseTracking
(
...
QJSValue
QMenu_Wrapper::hasMouseTracking
(
...
QJSValue
QMenu_Wrapper::setTabletTracking
(
...
QJSValue
QMenu_Wrapper::hasTabletTracking
(
...
QJSValue
QMenu_Wrapper::setWindowIconText
(
...
QJSValue
QMenu_Wrapper::setWindowFilePath
(
...
QJSValue
QMenu_Wrapper::setWindowOpacity
(
...
QJSValue
QMenu_Wrapper::isWindowModified
(
...
QJSValue
QMenu_Wrapper::setToolTipDuration
(
...
QJSValue
QMenu_Wrapper::setAccessibleName
(
...
QJSValue
QMenu_Wrapper::accessibleDescription
(
...
QJSValue
QMenu_Wrapper::setAccessibleDescription
(
...
QJSValue
QMenu_Wrapper::setLayoutDirection
(
...
QJSValue
QMenu_Wrapper::unsetLayoutDirection
(
...
QJSValue
QMenu_Wrapper::contextMenuPolicy
(
...
QJSValue
QMenu_Wrapper::setContextMenuPolicy
(
...
QJSValue
QMenu_Wrapper::setShortcutEnabled
(
...
QJSValue
QMenu_Wrapper::setShortcutAutoRepeat
(
...
QJSValue
QMenu_Wrapper::setUpdatesEnabled
(
...
QJSValue
QMenu_Wrapper::overrideWindowState
(
...
QJSValue
QMenu_Wrapper::setContentsMargins
(
...
QJSValue
QMenu_Wrapper::nextInFocusChain
(
...
QJSValue
QMenu_Wrapper::previousInFocusChain
(
...
QJSValue
QMenu_Wrapper::overrideWindowFlags
(
...
QJSValue
QMenu_Wrapper::autoFillBackground
(
...
QJSValue
QMenu_Wrapper::setAutoFillBackground
(
...
void
QMenu_Wrapper::customContextMenuRequestedEmitter(
    const QPoint& pos
) {
...
QJSValue
QMenu_Wrapper::inputMethodQuery
(
...
QJSValue
QMenu_Wrapper::inputMethodHints
(
...
QJSValue
QMenu_Wrapper::setInputMethodHints
(
...

{
    ...
    if (
        ...
        // call function of QMenu_Base class as
        // function has postfix inheritable class, overridable function):
        QMenu_Base* wb = getWrappedBase();
        if (wb==nullptr) {
            qWarning() << "QMenu::resizeEvent: using base but wrapper is not of type of base class";
            handler.trace();
            return QJSValue();
        }
...

{
    ...
    qWarning() << "no matching function variant found for addSection";
    handler.trace();
    return QJSValue();
...

{
    ...
    qWarning() << "no matching function variant found for insertSection";
    handler.trace();
    return QJSValue();
...
QJSValue
QMenu_Wrapper::setTearOffEnabled
(
...

{
    ...
    qWarning() << "no matching function variant found for setTearOffEnabled";
    handler.trace();
    return QJSValue();
...
QJSValue
QMenu_Wrapper::isTearOffEnabled
(
...

{
    ...
    qWarning() << "no matching function variant found for isTearOffEnabled";
    handler.trace();
    return QJSValue();
...
QJSValue
QMenu_Wrapper::isTearOffMenuVisible
(
...

{
    ...
    qWarning() << "no matching function variant found for isTearOffMenuVisible";
    handler.trace();
    return QJSValue();
...

{
    ...
    qWarning() << "no matching function variant found for showTearOffMenu";
    handler.trace();
    return QJSValue();
...

{
    ...
    qWarning() << "no matching function variant found for hideTearOffMenu";
    handler.trace();
    return QJSValue();
...
QJSValue
QMenu_Wrapper::setDefaultAction
(
...

{
    ...
    if (
        ...
        // convert js parameter to cpp: act (QAction)
...

{
    ...
    qWarning() << "no matching function variant found for popup";
    handler.trace();
    return QJSValue();
...

{
    ...
    qWarning() << "no matching function variant found for menuAction";
    handler.trace();
    return QJSValue();
...

{
    ...
    qWarning() << "no matching function variant found for setNoReplayFor";
    handler.trace();
    return QJSValue();
...

{
    ...
    qWarning() << "no matching function variant found for setAsDockMenu";
    handler.trace();
    return QJSValue();
...
// Class: QMenu
// Function: separatorsCollapsible
// Source:
// Static: false
// Parameters: 0
// preceding Parameters: -1
...
QJSValue
QMenu_Wrapper::separatorsCollapsible
(
...

{
    ...
    qWarning() << "no matching function variant found for separatorsCollapsible";
    handler.trace();
    return QJSValue();
...
// Class: QMenu
// Function: setSeparatorsCollapsible
// Source:
// Static: false
// Parameters: 1
// preceding Parameters: -1
...
QJSValue
QMenu_Wrapper::setSeparatorsCollapsible
(
...

{
    ...
    if (
        ...
        // convert js parameter to cpp: collapse (bool)
    ...
    qWarning() << "no matching function variant found for setSeparatorsCollapsible";
    handler.trace();
    return QJSValue();
...

{
    ...
    qWarning() << "no matching function variant found for toolTipsVisible";
    handler.trace();
    return QJSValue();
...
QJSValue
QMenu_Wrapper::setToolTipsVisible
(
...

{
    ...
    qWarning() << "no matching function variant found for setToolTipsVisible";
    handler.trace();
    return QJSValue();
...
// signal emitter: called when signal is emitted from wrapped object:
void
QMenu_Wrapper::aboutToShowEmitter(
...
// signal emitter: called when signal is emitted from wrapped object:
void
QMenu_Wrapper::aboutToHideEmitter(
...
// signal emitter: called when signal is emitted from wrapped object:
void
QMenu_Wrapper::triggeredEmitter(
    QAction* action
) {
    // convert cpp parameters to js:
...

{
    ...
    if (
        ...
        QMenu_Base* wb = getWrappedBase();
        if (wb==nullptr) {
            qWarning() << "QMenu::mouseMoveEvent: using base but wrapper is not of type of base class";
            handler.trace();
            return QJSValue();
        }
...

{
    ...
    if (
        ...
        QMenu_Base* wb = getWrappedBase();
        if (wb==nullptr) {
            qWarning() << "QMenu::paintEvent: using base but wrapper is not of type of base class";
            handler.trace();
            return QJSValue();
        }
