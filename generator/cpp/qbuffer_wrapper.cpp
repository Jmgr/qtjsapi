...
void QBuffer_Wrapper::init(RJSApi& handler) {
    ...
    // singleton wrapper:
    QJSValue mos = engine->newQMetaObject(&QBuffer_WrapperSingleton::staticMetaObject);
    engine->globalObject().setProperty("QBuffer_WrapperSingleton", mos);

    // create instance of singleton wrapper for static functions:
    QBuffer_WrapperSingleton * s = new QBuffer_WrapperSingleton(handler);
    engine->globalObject().setProperty("QBuffer_WrapperSingletonInstance", engine->newQObject(s));
...
QBuffer_Wrapper::QBuffer_Wrapper(RJSApi& h, QBuffer* o, bool wrappedCreated) : RJSWrapperObj(h), wrapped(o), wrappedCreated(wrappedCreated) {
