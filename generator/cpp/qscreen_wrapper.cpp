...
QList<RJSBasecaster_QScreen*> QScreen_Wrapper::basecasters_QScreen;
...
void QScreen_Wrapper::init(RJSApi& handler) {
    ...
    QString fileName = ":generator/js/QScreen.js";
...

{
    ...
    if (
        ...
        && RJSHelper::is_Qt_ScreenOrientation(handler, a2
                                             )
        ...
        a2_cpp = RJSHelper::js2cpp_Qt_ScreenOrientation(handler, a2);
...
QScreen_Wrapper::physicalSizeChangedEmitter(
    ...
    QJSValue a1_js = RJSHelper::cpp2js_QSizeF(
                         handler,
                         size
                     );
