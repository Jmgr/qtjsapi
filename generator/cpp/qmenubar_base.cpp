...
void QMenuBar_Base::paintEvent(
    QPaintEvent* event
) {

    //qDebug() << "QMenuBar_Base::paintEvent()";
...
void QMenuBar_Base::mouseMoveEvent(
    QMouseEvent* event
) {

    //qDebug() << "QMenuBar_Base::mouseMoveEvent()";
...
void QMenuBar_Base::resizeEvent(
    QResizeEvent* event
) {

    //qDebug() << "QMenuBar_Base::resizeEvent()";
