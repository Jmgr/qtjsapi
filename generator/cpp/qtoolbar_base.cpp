...
void QToolBar_Base::paintEvent(
    QPaintEvent* event
) {

    //qDebug() << "QToolBar_Base::paintEvent()";
...
void QToolBar_Base::mouseMoveEvent(
    QMouseEvent* event
) {

    //qDebug() << "QToolBar_Base::mouseMoveEvent()";
...
void QToolBar_Base::resizeEvent(
    QResizeEvent* event
) {

    //qDebug() << "QToolBar_Base::resizeEvent()";
