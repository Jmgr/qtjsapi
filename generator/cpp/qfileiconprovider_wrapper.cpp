...
QList<RJSBasecaster_QFileIconProvider*> QFileIconProvider_Wrapper::basecasters_QFileIconProvider;
...
void QFileIconProvider_Wrapper::init(RJSApi& handler) {
    ...
    RJSType_QFileIconProvider* t = new RJSType_QFileIconProvider();
    global.setProperty("RJSType_QFileIconProvider", engine->newQObject(t));
    ...
    QString fileName = ":generator/js/QFileIconProvider.js";
