...
QList<RJSBasecaster_QLayout*> QLayout_Wrapper::basecasters_QLayout;
...
QJSValue
QLayout_WrapperSingleton::closestAcceptableSize
(
...
void QLayout_Wrapper::init(RJSApi& handler) {

    //qmlRegisterType<QLayout_Wrapper>("org.qcad", 1, 0, "QLayout_Wrapper");
    qmlRegisterInterface<QLayout_Wrapper>("QLayout_Wrapper", 1);
    ...
    RJSType_QLayout* t = new RJSType_QLayout();
    global.setProperty("RJSType_QLayout", engine->newQObject(t));

    // initialize ID for this type:
    RJSType_QLayout::getIdStatic();



    // wrapper:
    QJSValue mo = engine->newQMetaObject(&QLayout_Wrapper::staticMetaObject);
    engine->globalObject().setProperty("QLayout_Wrapper", mo);



    // JS base class:
    //QJSValue mob = engine->newQMetaObject(&QLayout_BaseJs::staticMetaObject);
    //engine->globalObject().setProperty("QLayout_BaseJs", mob);

    // singleton wrapper:
    QJSValue mos = engine->newQMetaObject(&QLayout_WrapperSingleton::staticMetaObject);
    engine->globalObject().setProperty("QLayout_WrapperSingleton", mos);

    // create instance of singleton wrapper for static functions:
    QLayout_WrapperSingleton * s = new QLayout_WrapperSingleton(handler);
...
QLayout_Wrapper::QLayout_Wrapper(QJSEngine* e) : wrapped(nullptr), wrappedCreated(false) {
        //setObjectName("QLayout_Wrapper");
        setEngine(e);
...
QLayout_Wrapper::QLayout_Wrapper(RJSApi& h, QLayout* o, bool wrappedCreated) : RJSWrapperObj(h), wrapped(o), wrappedCreated(wrappedCreated) {
    //RDebug::incCounter(QString("QLayout_Wrapper_") + handler.getEngine()->objectName());
    //RDebug::incCounter(QString("QLayout_Wrapper"));
    //setObjectName("QLayout_Wrapper");
    //setHandler(h);
...
QLayout_Wrapper::~QLayout_Wrapper() {
    //RDebug::decCounter(QString("QLayout_Wrapper_") + handler.getEngine()->objectName());
    //RDebug::decCounter(QString("QLayout_Wrapper"));

    //qDebug() << "QLayout_Wrapper::~QLayout_Wrapper";
    ...
    if (wrappedCreated) {
        ...
        //qDebug() << "NOT deleting instance of QLayout";
...
void QLayout_Wrapper::initConnections() {
...

{
    ...
    if (
        ...
        //((QLayout_Base*)wrapped)->setHandler(handler);

        // store self to call into JS:
        ((QLayout_Base*)wrapped)->self = handler.getSelf();
    ...
    qWarning() << "no matching constructor variant found for QLayout";
    wrapped = nullptr;
    wrappedCreated = false;
    handler.trace();
...
QJSValue
QLayout_Wrapper::signalsBlocked
(
...
QJSValue
QLayout_Wrapper::installEventFilter
(
...
QJSValue
QLayout_Wrapper::removeEventFilter
(
...
QJSValue
QLayout_Wrapper::dumpObjectTree
(
...
QJSValue
QLayout_Wrapper::dumpObjectInfo
(
...
QJSValue
QLayout_Wrapper::dynamicPropertyNames
(
...
QJSValue
QLayout_Wrapper::hasHeightForWidth
(
...
QJSValue
QLayout_Wrapper::heightForWidth
(
...
QJSValue
QLayout_Wrapper::minimumHeightForWidth
(
...
QJSValue
QLayout_Wrapper::setContentsMargins
(
...
QJSValue
QLayout_Wrapper::contentsMargins
(
...
QJSValue
QLayout_Wrapper::setSizeConstraint
(
...
QJSValue
QLayout_Wrapper::sizeConstraint
(
...
QJSValue
QLayout_Wrapper::expandingDirections
(
...

{

    {
        ...
        // call function of QLayout_Base class as
        // function has postfix inheritable class, overridable function):
        QLayout_Base* wb = getWrappedBase();
        if (wb==nullptr) {
            qWarning() << "QLayout::minimumSize: using base but wrapper is not of type of base class";
            handler.trace();
            return QJSValue();
        }
...

{
    ...
    if (
        ...
        QLayout_Base* wb = getWrappedBase();
        if (wb==nullptr) {
            qWarning() << "QLayout::setGeometry: using base but wrapper is not of type of base class";
            handler.trace();
            return QJSValue();
        }
...
QJSValue
QLayout_Wrapper::totalHeightForWidth
(
...
QJSValue
QLayout_Wrapper::totalMinimumSize
(
...
QJSValue
QLayout_Wrapper::totalMaximumSize
(
