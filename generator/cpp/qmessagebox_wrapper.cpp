...
QList<RJSBasecaster_QMessageBox*> QMessageBox_Wrapper::basecasters_QMessageBox;
...
QJSValue
QMessageBox_WrapperSingleton::tr
(
...
QJSValue
QMessageBox_WrapperSingleton::setTabOrder
(
...
QJSValue
QMessageBox_WrapperSingleton::mouseGrabber
(
...
QJSValue
QMessageBox_WrapperSingleton::keyboardGrabber
(
...
QJSValue
QMessageBox_WrapperSingleton::information
(
...

{
    ...
    if (
        ...
        && RJSHelper::is_QMessageBox_StandardButtons(handler, a4
                , true

                                                    )

        && RJSHelper::is_QMessageBox_StandardButton(handler, a5
                , true
        ...
        // convert js parameter to cpp: buttons (QMessageBox::StandardButtons)

        QMessageBox::StandardButtons a4_cpp;


        if (a4.isUndefined()) {
            a4_cpp = QMessageBox::Ok;
        }
        else {
            a4_cpp = RJSHelper::js2cpp_QMessageBox_StandardButtons(handler, a4);
        }

        // convert js parameter to cpp: defaultButton (QMessageBox::StandardButton)

        QMessageBox::StandardButton a5_cpp;


        if (a5.isUndefined()) {
            a5_cpp = QMessageBox::NoButton;
        }
        else {
            a5_cpp = RJSHelper::js2cpp_QMessageBox_StandardButton(handler, a5);
        }
        ...
        // return type: QMessageBox::StandardButton

        return RJSHelper::cpp2js_QMessageBox_StandardButton(
                   handler,
                   // non-copyable: false
                   res
    ...
    if (
        ...
        && RJSHelper::is_QMessageBox_StandardButton(handler, a4
                                                   )
        ...
        // convert js parameter to cpp: button0 (QMessageBox::StandardButton)

        QMessageBox::StandardButton a4_cpp;

        a4_cpp = RJSHelper::js2cpp_QMessageBox_StandardButton(handler, a4);

        // convert js parameter to cpp: button1 (QMessageBox::StandardButton)
    ...
    qWarning() << "no matching function variant found for information";
    handler.trace();
    return QJSValue();
...
QJSValue
QMessageBox_WrapperSingleton::question
(
...

{
    ...
    if (
        ...
        if (a4.isUndefined()) {
            a4_cpp = QMessageBox::StandardButtons(QMessageBox::Yes|QMessageBox::No);
        }
        else {
            a4_cpp = RJSHelper::js2cpp_QMessageBox_StandardButtons(handler, a4);
        }
    ...
    qWarning() << "no matching function variant found for question";
    handler.trace();
    return QJSValue();
...
QJSValue
QMessageBox_WrapperSingleton::warning
(
...
QJSValue
QMessageBox_WrapperSingleton::critical
(
...

{
    ...
    qWarning() << "no matching function variant found for critical";
    handler.trace();
    return QJSValue();
...
QJSValue
QMessageBox_WrapperSingleton::about
(
...

{
    ...
    qWarning() << "no matching function variant found for about";
    handler.trace();
    return QJSValue();
...
QJSValue
QMessageBox_WrapperSingleton::aboutQt
(
...
void QMessageBox_Wrapper::init(RJSApi& handler) {

    //qmlRegisterType<QMessageBox_Wrapper>("org.qcad", 1, 0, "QMessageBox_Wrapper");
    qmlRegisterInterface<QMessageBox_Wrapper>("QMessageBox_Wrapper", 1);
    ...
    RJSType_QMessageBox* t = new RJSType_QMessageBox();
    global.setProperty("RJSType_QMessageBox", engine->newQObject(t));
    ...
    // wrapper:
    QJSValue mo = engine->newQMetaObject(&QMessageBox_Wrapper::staticMetaObject);
    engine->globalObject().setProperty("QMessageBox_Wrapper", mo);



    // JS base class:
    //QJSValue mob = engine->newQMetaObject(&QMessageBox_BaseJs::staticMetaObject);
    //engine->globalObject().setProperty("QMessageBox_BaseJs", mob);

    // singleton wrapper:
    QJSValue mos = engine->newQMetaObject(&QMessageBox_WrapperSingleton::staticMetaObject);
    engine->globalObject().setProperty("QMessageBox_WrapperSingleton", mos);

    // create instance of singleton wrapper for static functions:
    QMessageBox_WrapperSingleton * s = new QMessageBox_WrapperSingleton(handler);
...
QMessageBox_Wrapper::QMessageBox_Wrapper(QJSEngine* e) : wrapped(nullptr), wrappedCreated(false) {
        //setObjectName("QMessageBox_Wrapper");
        setEngine(e);
...
QMessageBox_Wrapper::QMessageBox_Wrapper(RJSApi& h, QMessageBox* o, bool wrappedCreated) : RJSWrapperObj(h), wrapped(o), wrappedCreated(wrappedCreated) {
    //RDebug::incCounter(QString("QMessageBox_Wrapper_") + handler.getEngine()->objectName());
    //RDebug::incCounter(QString("QMessageBox_Wrapper"));
    //setObjectName("QMessageBox_Wrapper");
    //setHandler(h);
...
// destructor:
QMessageBox_Wrapper::~QMessageBox_Wrapper() {
    //RDebug::decCounter(QString("QMessageBox_Wrapper_") + handler.getEngine()->objectName());
    //RDebug::decCounter(QString("QMessageBox_Wrapper"));

    //qDebug() << "QMessageBox_Wrapper::~QMessageBox_Wrapper";
    ...
    if (wrappedCreated) {
        ...
        //qDebug() << "NOT deleting instance of QMessageBox";
...
void QMessageBox_Wrapper::initConnections() {
...

{
    ...
    // check parameter types:
    if (
        RJSHelper::is_QMessageBox_Icon(handler, a1
                                      )
        ...
        // convert js parameter to cpp: icon (QMessageBox::Icon)

        QMessageBox::Icon a1_cpp;

        a1_cpp = RJSHelper::js2cpp_QMessageBox_Icon(handler, a1);
        ...
        if (a6.isUndefined()) {
            a6_cpp = Qt::Dialog|Qt::MSWindowsFixedSizeDialogHint;
        }
        else {
        ...
        //((QMessageBox_Base*)wrapped)->setHandler(handler);

        // store self to call into JS:
        ((QMessageBox_Base*)wrapped)->self = handler.getSelf();
    ...
    qWarning() << "no matching constructor variant found for QMessageBox";
    wrapped = nullptr;
    wrappedCreated = false;
    handler.trace();
...
QJSValue
QMessageBox_Wrapper::objectName
(
...
QJSValue
QMessageBox_Wrapper::setObjectName
(
...
QJSValue
QMessageBox_Wrapper::isWidgetType
(
...
QJSValue
QMessageBox_Wrapper::isWindowType
(
...
QJSValue
QMessageBox_Wrapper::signalsBlocked
(
...
QJSValue
QMessageBox_Wrapper::blockSignals
(
...
QJSValue
QMessageBox_Wrapper::installEventFilter
(
...
QJSValue
QMessageBox_Wrapper::removeEventFilter
(
...
QJSValue
QMessageBox_Wrapper::dumpObjectTree
(
...
QJSValue
QMessageBox_Wrapper::dumpObjectInfo
(
...
QJSValue
QMessageBox_Wrapper::setProperty
(
...
QJSValue
QMessageBox_Wrapper::dynamicPropertyNames
(
...
QJSValue
QMessageBox_Wrapper::deleteLater
(
...
QJSValue
QMessageBox_Wrapper::createWinId
(
...
QJSValue
QMessageBox_Wrapper::windowModality
(
...
QJSValue
QMessageBox_Wrapper::isEnabledTo
(
...
QJSValue
QMessageBox_Wrapper::setEnabled
(
...
QJSValue
QMessageBox_Wrapper::setDisabled
(
...
QJSValue
QMessageBox_Wrapper::setWindowModified
(
...
QJSValue
QMessageBox_Wrapper::frameGeometry
(
...
QJSValue
QMessageBox_Wrapper::normalGeometry
(
...
QJSValue
QMessageBox_Wrapper::childrenRect
(
...
QJSValue
QMessageBox_Wrapper::childrenRegion
(
...
QJSValue
QMessageBox_Wrapper::minimumSize
(
...
QJSValue
QMessageBox_Wrapper::maximumSize
(
...
QJSValue
QMessageBox_Wrapper::minimumWidth
(
...
QJSValue
QMessageBox_Wrapper::minimumHeight
(
...
QJSValue
QMessageBox_Wrapper::maximumWidth
(
...
QJSValue
QMessageBox_Wrapper::maximumHeight
(
...
QJSValue
QMessageBox_Wrapper::setMinimumSize
(
...
QJSValue
QMessageBox_Wrapper::setMaximumSize
(
...
QJSValue
QMessageBox_Wrapper::setMinimumWidth
(
...
QJSValue
QMessageBox_Wrapper::setMinimumHeight
(
...
QJSValue
QMessageBox_Wrapper::setMaximumWidth
(
...
QJSValue
QMessageBox_Wrapper::setMaximumHeight
(
...
QJSValue
QMessageBox_Wrapper::sizeIncrement
(
...
QJSValue
QMessageBox_Wrapper::setSizeIncrement
(
...
QJSValue
QMessageBox_Wrapper::setBaseSize
(
...
QJSValue
QMessageBox_Wrapper::setFixedSize
(
...
QJSValue
QMessageBox_Wrapper::setFixedWidth
(
...
QJSValue
QMessageBox_Wrapper::setFixedHeight
(
...
QJSValue
QMessageBox_Wrapper::mapToGlobal
(
...
QJSValue
QMessageBox_Wrapper::mapFromGlobal
(
...
QJSValue
QMessageBox_Wrapper::mapToParent
(
...
QJSValue
QMessageBox_Wrapper::mapFromParent
(
...
QJSValue
QMessageBox_Wrapper::nativeParentWidget
(
...
QJSValue
QMessageBox_Wrapper::topLevelWidget
(
...
QJSValue
QMessageBox_Wrapper::setPalette
(
...
QJSValue
QMessageBox_Wrapper::setBackgroundRole
(
...
QJSValue
QMessageBox_Wrapper::backgroundRole
(
...
QJSValue
QMessageBox_Wrapper::setForegroundRole
(
...
QJSValue
QMessageBox_Wrapper::foregroundRole
(
...
QJSValue
QMessageBox_Wrapper::unsetCursor
(
...
QJSValue
QMessageBox_Wrapper::setMouseTracking
(
...
QJSValue
QMessageBox_Wrapper::hasMouseTracking
(
...
QJSValue
QMessageBox_Wrapper::underMouse
(
...
QJSValue
QMessageBox_Wrapper::setTabletTracking
(
...
QJSValue
QMessageBox_Wrapper::hasTabletTracking
(
...
QJSValue
QMessageBox_Wrapper::grabGesture
(
...
QJSValue
QMessageBox_Wrapper::ungrabGesture
(
...
QJSValue
QMessageBox_Wrapper::setStyleSheet
(
...
QJSValue
QMessageBox_Wrapper::styleSheet
(
...
QJSValue
QMessageBox_Wrapper::windowTitle
(
...
QJSValue
QMessageBox_Wrapper::setWindowIcon
(
...
QJSValue
QMessageBox_Wrapper::windowIcon
(
...
QJSValue
QMessageBox_Wrapper::setWindowIconText
(
...
QJSValue
QMessageBox_Wrapper::windowIconText
(
...
QJSValue
QMessageBox_Wrapper::setWindowRole
(
...
QJSValue
QMessageBox_Wrapper::windowRole
(
...
QJSValue
QMessageBox_Wrapper::setWindowFilePath
(
...
QJSValue
QMessageBox_Wrapper::windowFilePath
(
...
QJSValue
QMessageBox_Wrapper::setWindowOpacity
(
...
QJSValue
QMessageBox_Wrapper::windowOpacity
(
...
QJSValue
QMessageBox_Wrapper::isWindowModified
(
...
QJSValue
QMessageBox_Wrapper::setToolTip
(
...
QJSValue
QMessageBox_Wrapper::setToolTipDuration
(
...
QJSValue
QMessageBox_Wrapper::toolTipDuration
(
...
QJSValue
QMessageBox_Wrapper::setStatusTip
(
...
QJSValue
QMessageBox_Wrapper::setWhatsThis
(
...
QJSValue
QMessageBox_Wrapper::accessibleName
(
...
QJSValue
QMessageBox_Wrapper::setAccessibleName
(
...
QJSValue
QMessageBox_Wrapper::accessibleDescription
(
...
QJSValue
QMessageBox_Wrapper::setAccessibleDescription
(
...
QJSValue
QMessageBox_Wrapper::setLayoutDirection
(
...
QJSValue
QMessageBox_Wrapper::layoutDirection
(
...
QJSValue
QMessageBox_Wrapper::unsetLayoutDirection
(
...
QJSValue
QMessageBox_Wrapper::unsetLocale
(
...
QJSValue
QMessageBox_Wrapper::isRightToLeft
(
...
QJSValue
QMessageBox_Wrapper::isLeftToRight
(
...
QJSValue
QMessageBox_Wrapper::isActiveWindow
(
...
QJSValue
QMessageBox_Wrapper::activateWindow
(
...
QJSValue
QMessageBox_Wrapper::clearFocus
(
...
QJSValue
QMessageBox_Wrapper::focusPolicy
(
...
QJSValue
QMessageBox_Wrapper::setFocusPolicy
(
...
QJSValue
QMessageBox_Wrapper::setFocusProxy
(
...
QJSValue
QMessageBox_Wrapper::focusProxy
(
...
QJSValue
QMessageBox_Wrapper::contextMenuPolicy
(
...
QJSValue
QMessageBox_Wrapper::setContextMenuPolicy
(
...
QJSValue
QMessageBox_Wrapper::releaseMouse
(
...
QJSValue
QMessageBox_Wrapper::grabKeyboard
(
...
QJSValue
QMessageBox_Wrapper::releaseKeyboard
(
...
QJSValue
QMessageBox_Wrapper::grabShortcut
(
...
QJSValue
QMessageBox_Wrapper::releaseShortcut
(
...
QJSValue
QMessageBox_Wrapper::setShortcutEnabled
(
...
QJSValue
QMessageBox_Wrapper::setShortcutAutoRepeat
(
...
QJSValue
QMessageBox_Wrapper::updatesEnabled
(
...
QJSValue
QMessageBox_Wrapper::setUpdatesEnabled
(
...
QJSValue
QMessageBox_Wrapper::showMinimized
(
...
QJSValue
QMessageBox_Wrapper::showMaximized
(
...
QJSValue
QMessageBox_Wrapper::showFullScreen
(
...
QJSValue
QMessageBox_Wrapper::showNormal
(
...
QJSValue
QMessageBox_Wrapper::stackUnder
(
...
QJSValue
QMessageBox_Wrapper::setGeometry
(
...
QJSValue
QMessageBox_Wrapper::saveGeometry
(
...
QJSValue
QMessageBox_Wrapper::restoreGeometry
(
...
QJSValue
QMessageBox_Wrapper::adjustSize
(
...
QJSValue
QMessageBox_Wrapper::isVisibleTo
(
...
QJSValue
QMessageBox_Wrapper::isMinimized
(
...
QJSValue
QMessageBox_Wrapper::isMaximized
(
...
QJSValue
QMessageBox_Wrapper::isFullScreen
(
...
QJSValue
QMessageBox_Wrapper::windowState
(
...
QJSValue
QMessageBox_Wrapper::setWindowState
(
...
QJSValue
QMessageBox_Wrapper::overrideWindowState
(
...
QJSValue
QMessageBox_Wrapper::sizePolicy
(
...
QJSValue
QMessageBox_Wrapper::setSizePolicy
(
...
QJSValue
QMessageBox_Wrapper::heightForWidth
(
...
QJSValue
QMessageBox_Wrapper::hasHeightForWidth
(
...
QJSValue
QMessageBox_Wrapper::visibleRegion
(
...
QJSValue
QMessageBox_Wrapper::setContentsMargins
(
...
QJSValue
QMessageBox_Wrapper::contentsMargins
(
...
QJSValue
QMessageBox_Wrapper::contentsRect
(
...
QJSValue
QMessageBox_Wrapper::updateGeometry
(
...
QJSValue
QMessageBox_Wrapper::focusWidget
(
...
QJSValue
QMessageBox_Wrapper::nextInFocusChain
(
...
QJSValue
QMessageBox_Wrapper::previousInFocusChain
(
...
QJSValue
QMessageBox_Wrapper::acceptDrops
(
...
QJSValue
QMessageBox_Wrapper::setAcceptDrops
(
...
QJSValue
QMessageBox_Wrapper::addActions
(
...
QJSValue
QMessageBox_Wrapper::insertActions
(
...
QJSValue
QMessageBox_Wrapper::insertAction
(
...
QJSValue
QMessageBox_Wrapper::removeAction
(
...
QJSValue
QMessageBox_Wrapper::parentWidget
(
...
QJSValue
QMessageBox_Wrapper::setWindowFlags
(
...
QJSValue
QMessageBox_Wrapper::windowFlags
(
...
QJSValue
QMessageBox_Wrapper::setWindowFlag
(
...
QJSValue
QMessageBox_Wrapper::overrideWindowFlags
(
...
QJSValue
QMessageBox_Wrapper::windowType
(
...
QJSValue
QMessageBox_Wrapper::setAttribute
(
...
QJSValue
QMessageBox_Wrapper::testAttribute
(
...
QJSValue
QMessageBox_Wrapper::ensurePolished
(
...
QJSValue
QMessageBox_Wrapper::isAncestorOf
(
...
QJSValue
QMessageBox_Wrapper::autoFillBackground
(
...
QJSValue
QMessageBox_Wrapper::setAutoFillBackground
(
...
void
QMessageBox_Wrapper::customContextMenuRequestedEmitter(
    const QPoint& pos
) {
...
QJSValue
QMessageBox_Wrapper::inputMethodQuery
(
...
QJSValue
QMessageBox_Wrapper::inputMethodHints
(
...
QJSValue
QMessageBox_Wrapper::setInputMethodHints
(
...
QJSValue
QMessageBox_Wrapper::setVisible
(
...
QJSValue
QMessageBox_Wrapper::minimumSizeHint
(
...
QJSValue
QMessageBox_Wrapper::setSizeGripEnabled
(
...
QJSValue
QMessageBox_Wrapper::isSizeGripEnabled
(
...
// signal emitter: called when signal is emitted from wrapped object:
void
QMessageBox_Wrapper::finishedEmitter(
    int result
) {
    // convert cpp parameters to js:
...
// signal emitter: called when signal is emitted from wrapped object:
void
QMessageBox_Wrapper::acceptedEmitter(
...
// signal emitter: called when signal is emitted from wrapped object:
void
QMessageBox_Wrapper::rejectedEmitter(
...

{
    ...
    if (
        ...
        && RJSHelper::is_QMessageBox_ButtonRole(handler, a2
                                               )
        ...
        // convert js parameter to cpp: role (QMessageBox::ButtonRole)

        QMessageBox::ButtonRole a2_cpp;

        a2_cpp = RJSHelper::js2cpp_QMessageBox_ButtonRole(handler, a2);
    ...
    if (
        ...
        return RJSHelper::cpp2js_QPushButton(
                   handler,
                   // non-copyable: true
                   res
    ...
    // check parameter types:
    if (
        RJSHelper::is_QMessageBox_StandardButton(handler, a1
                                                )
        ...
        // convert js parameter to cpp: button (QMessageBox::StandardButton)

        QMessageBox::StandardButton a1_cpp;

        a1_cpp = RJSHelper::js2cpp_QMessageBox_StandardButton(handler, a1);
...
QJSValue
QMessageBox_Wrapper::removeButton
(
...
QJSValue
QMessageBox_Wrapper::buttonRole
(
...

{
    ...
    if (
        ...
        // return type: QMessageBox::ButtonRole

        return RJSHelper::cpp2js_QMessageBox_ButtonRole(
                   handler,
                   // non-copyable: false
                   res
    ...
    qWarning() << "no matching function variant found for buttonRole";
    handler.trace();
    return QJSValue();
...
QJSValue
QMessageBox_Wrapper::setStandardButtons
(
...

{
    ...
    // check parameter types:
    if (
        RJSHelper::is_QMessageBox_StandardButtons(handler, a1
                                                 )
        ...
        QMessageBox::StandardButtons a1_cpp;

        a1_cpp = RJSHelper::js2cpp_QMessageBox_StandardButtons(handler, a1);
    ...
    qWarning() << "no matching function variant found for setStandardButtons";
    handler.trace();
    return QJSValue();
...
QJSValue
QMessageBox_Wrapper::standardButtons
(
...

{

    {
        ...
        // return type: QMessageBox::StandardButtons

        return RJSHelper::cpp2js_QMessageBox_StandardButtons(
                   handler,
                   // non-copyable: false
                   res
    ...
    qWarning() << "no matching function variant found for standardButtons";
    handler.trace();
    return QJSValue();
...
QJSValue
QMessageBox_Wrapper::standardButton
(
...

{
    ...
    qWarning() << "no matching function variant found for standardButton";
    handler.trace();
    return QJSValue();
...

{
    ...
    if (
        ...
        // convert js parameter to cpp: which (QMessageBox::StandardButton)
...
QJSValue
QMessageBox_Wrapper::defaultButton
(
...

{
    ...
    qWarning() << "no matching function variant found for defaultButton";
    handler.trace();
    return QJSValue();
...
QJSValue
QMessageBox_Wrapper::setDefaultButton
(
...

{
    ...
    qWarning() << "no matching function variant found for setDefaultButton";
    handler.trace();
    return QJSValue();
...
QJSValue
QMessageBox_Wrapper::escapeButton
(
...

{
    ...
    qWarning() << "no matching function variant found for escapeButton";
    handler.trace();
    return QJSValue();
...
QJSValue
QMessageBox_Wrapper::setEscapeButton
(
...

{
    ...
    qWarning() << "no matching function variant found for setEscapeButton";
    handler.trace();
    return QJSValue();
...
QJSValue
QMessageBox_Wrapper::clickedButton
(
...

{
    ...
    qWarning() << "no matching function variant found for clickedButton";
    handler.trace();
    return QJSValue();
...

{

    {
        ...
        // return type: QMessageBox::Icon

        return RJSHelper::cpp2js_QMessageBox_Icon(
                   handler,
                   // non-copyable: false
                   res
...

{
    ...
    if (
        ...
        // convert js parameter to cpp:  (QMessageBox::Icon)
...
QJSValue
QMessageBox_Wrapper::iconPixmap
(
...

{
    ...
    qWarning() << "no matching function variant found for iconPixmap";
    handler.trace();
    return QJSValue();
...
QJSValue
QMessageBox_Wrapper::setIconPixmap
(
...

{
    ...
    qWarning() << "no matching function variant found for setIconPixmap";
    handler.trace();
    return QJSValue();
...
QJSValue
QMessageBox_Wrapper::textFormat
(
...

{

    {
        ...
        // return type: Qt::TextFormat

        return RJSHelper::cpp2js_Qt_TextFormat(
                   handler,
                   // non-copyable: false
                   res
    ...
    qWarning() << "no matching function variant found for textFormat";
    handler.trace();
    return QJSValue();
...
QJSValue
QMessageBox_Wrapper::setTextFormat
(
...

{
    ...
    // check parameter types:
    if (
        RJSHelper::is_Qt_TextFormat(handler, a1
                                   )
        ...
        // convert js parameter to cpp: format (Qt::TextFormat)

        Qt::TextFormat a1_cpp;

        a1_cpp = RJSHelper::js2cpp_Qt_TextFormat(handler, a1);
    ...
    qWarning() << "no matching function variant found for setTextFormat";
    handler.trace();
    return QJSValue();
...
QJSValue
QMessageBox_Wrapper::setTextInteractionFlags
(
...
QJSValue
QMessageBox_Wrapper::textInteractionFlags
(
...
QJSValue
QMessageBox_Wrapper::setCheckBox
(
...

{
    ...
    // check parameter types:
    if (
        RJSHelper::is_QCheckBox_ptr(handler, a1
                                    , true
        ...
        // convert js parameter to cpp: cb (QCheckBox)
        ...
        a1_cpp = RJSHelper::js2cpp_QCheckBox_ptr(handler, a1);
    ...
    qWarning() << "no matching function variant found for setCheckBox";
    handler.trace();
    return QJSValue();
...

{

    {
        ...
        return RJSHelper::cpp2js_QCheckBox(
                   handler,
                   // non-copyable: true
                   res
    ...
    qWarning() << "no matching function variant found for checkBox";
    handler.trace();
    return QJSValue();
...
QJSValue
QMessageBox_Wrapper::informativeText
(
...

{
    ...
    qWarning() << "no matching function variant found for informativeText";
    handler.trace();
    return QJSValue();
...
QJSValue
QMessageBox_Wrapper::setInformativeText
(
...

{
    ...
    qWarning() << "no matching function variant found for setInformativeText";
    handler.trace();
    return QJSValue();
...
QJSValue
QMessageBox_Wrapper::detailedText
(
...

{
    ...
    qWarning() << "no matching function variant found for detailedText";
    handler.trace();
    return QJSValue();
...
QJSValue
QMessageBox_Wrapper::setDetailedText
(
...

{
    ...
    qWarning() << "no matching function variant found for setDetailedText";
    handler.trace();
    return QJSValue();
...
QJSValue
QMessageBox_Wrapper::setWindowTitle
(
...
QJSValue
QMessageBox_Wrapper::setWindowModality
(
...
// signal emitter: called when signal is emitted from wrapped object:
void
QMessageBox_Wrapper::buttonClickedEmitter(
    QAbstractButton* button
) {
    // convert cpp parameters to js:

    // parameter: button (QAbstractButton)
...

{
    ...
    if (
        ...
        // call function of QMessageBox_Base class as
        // function has postfix inheritable class, overridable function):
        QMessageBox_Base* wb = getWrappedBase();
        if (wb==nullptr) {
            qWarning() << "QMessageBox::resizeEvent: using base but wrapper is not of type of base class";
            handler.trace();
            return QJSValue();
        }
