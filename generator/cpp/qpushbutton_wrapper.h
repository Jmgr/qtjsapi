...
#ifndef QPUSHBUTTON_H_WRAPPER
#define QPUSHBUTTON_H_WRAPPER
...
// wrapped object is QPushButton_Base class if new object is created:
...
public:
    //Q_INVOKABLE
    QPushButton_WrapperSingleton(RJSApi& h)
        : QObject(),
          handler(h)
...
private:
    RJSApi& handler;
    //static QPushButton_WrapperSingleton* _singleInstance;
...
class QTJSAPI_EXPORT QPushButton_Wrapper : public RJSWrapperObj {
    ...
    Q_PROPERTY(
        ...
        QJSValue
        autoDefault READ autoDefault WRITE setAutoDefault
    )

    Q_PROPERTY(

        QJSValue
        default READ isDefault WRITE setDefault
    )

    Q_PROPERTY(

        QJSValue
        flat READ isFlat WRITE setFlat
    )


private:
    // disable copy constructor:
    QPushButton_Wrapper(const QPushButton_Wrapper&);

public:
    // initialization of QPushButton:
    ...
    static QPushButton* castToBase(void* vp, /*RJSType ID*/ int t) {
        ...
        qWarning() << "QPushButton_Wrapper::castToBase: type not found: " << RJSHelper::getTypeName(t);

        return nullptr;

    }

    static QPushButton* getWrappedBase(RJSWrapper* wrapper) {
        int t = wrapper->getWrappedType();
        void* vp = wrapper->getWrappedVoid();
        if (vp==nullptr) {
            //qWarning() << "getWrapped_QPushButton*: wrapper wraps NULL";
        }

        QPushButton* ret = castToBase(vp, t);
        if (ret==nullptr && vp!=nullptr) {
            qWarning() << "QPushButton*_Wrapper::getWrappedBase: extracted type " << t << "from wrapper is NULL";
        }
        return ret;
    }
    ...
    // special constructor used as prototype:
          ...
          Q_INVOKABLE
          QPushButton_Wrapper(QJSEngine* e);
    ...
    */
    ...
    //Q_INVOKABLE
    QPushButton_Wrapper(RJSApi& h, QPushButton* o, bool wrappedCreated);


    // destructor:

    virtual ~QPushButton_Wrapper();
...
public:
    ...
    QPushButton_Base* getWrappedBase() {
        QPushButton* w = getWrapped();
        return dynamic_cast<QPushButton_Base*>(w);
    }

    QPushButton_Base* getWrappedBase() const {
        QPushButton* w = getWrapped();
        return dynamic_cast<QPushButton_Base*>(w);
    }
...
Q_DECLARE_METATYPE(QPushButton_Wrapper*)

Q_DECLARE_INTERFACE(QPushButton_Wrapper, "org.qcad.QPushButton_Wrapper")
