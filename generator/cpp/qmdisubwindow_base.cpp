...
void QMdiSubWindow_Base::paintEvent(
    QPaintEvent* event
) {

    //qDebug() << "QMdiSubWindow_Base::paintEvent()";
...
void QMdiSubWindow_Base::mouseMoveEvent(
    QMouseEvent* event
) {

    //qDebug() << "QMdiSubWindow_Base::mouseMoveEvent()";
...
void QMdiSubWindow_Base::resizeEvent(
    QResizeEvent* event
) {

    //qDebug() << "QMdiSubWindow_Base::resizeEvent()";
