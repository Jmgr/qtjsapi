...
QList<RJSBasecaster_QUiLoader*> QUiLoader_Wrapper::basecasters_QUiLoader;
...
void QUiLoader_Wrapper::init(RJSApi& handler) {
    ...
    RJSType_QUiLoader* t = new RJSType_QUiLoader();
    global.setProperty("RJSType_QUiLoader", engine->newQObject(t));
...

{
    ...
    if (
        ...
        return RJSHelper::cpp2js_QActionGroup(
                   handler,
                   // non-copyable: true
                   res
