...
void QStackedWidget_Base::mousePressEvent(
    QMouseEvent* event
) {

    //qDebug() << "QStackedWidget_Base::mousePressEvent()";
...
void QStackedWidget_Base::mouseReleaseEvent(
    QMouseEvent* event
) {

    //qDebug() << "QStackedWidget_Base::mouseReleaseEvent()";
...
void QStackedWidget_Base::actionEvent(
    QActionEvent* event
) {

    //qDebug() << "QStackedWidget_Base::actionEvent()";
...
void QStackedWidget_Base::paintEvent(
    QPaintEvent* event
) {

    //qDebug() << "QStackedWidget_Base::paintEvent()";
...
void QStackedWidget_Base::mouseMoveEvent(
    QMouseEvent* event
) {

    //qDebug() << "QStackedWidget_Base::mouseMoveEvent()";
...
void QStackedWidget_Base::resizeEvent(
    QResizeEvent* event
) {

    //qDebug() << "QStackedWidget_Base::resizeEvent()";
...
bool QStackedWidget_Base::event(
    QEvent* e
) {

    //qDebug() << "QStackedWidget_Base::event()";
