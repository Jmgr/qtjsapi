...
void QProgressDialog_Base::mousePressEvent(
    QMouseEvent* event
) {

    //qDebug() << "QProgressDialog_Base::mousePressEvent()";
...
void QProgressDialog_Base::mouseReleaseEvent(
    QMouseEvent* event
) {

    //qDebug() << "QProgressDialog_Base::mouseReleaseEvent()";
...
void QProgressDialog_Base::mouseMoveEvent(
    QMouseEvent* event
) {

    //qDebug() << "QProgressDialog_Base::mouseMoveEvent()";
...
void QProgressDialog_Base::paintEvent(
    QPaintEvent* event
) {

    //qDebug() << "QProgressDialog_Base::paintEvent()";
...
void QProgressDialog_Base::actionEvent(
    QActionEvent* event
) {

    //qDebug() << "QProgressDialog_Base::actionEvent()";
...
void QProgressDialog_Base::resizeEvent(
    QResizeEvent* a1
) {

    //qDebug() << "QProgressDialog_Base::resizeEvent()";
